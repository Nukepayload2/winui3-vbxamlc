...
Namespace ");
 ...
 if (Model.CodeInfo.IsApplication) 
 {
     ...
     { 
            this.Write("#If DISABLE_XAML_GENERATED_MAIN Then\r\n        Private Shared Sub _XamlGeneratedCr" +
                    "eateApplicationInstance()   \' 实现部分不带 Partial（带 Partial 报 BC31433）；与 AppPass1 的声明" +
                    "部分配对\r\n            Dim _application As New ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.CodeInfo.ClassName.ShortName));
            this.Write("()   \' VB 禁止裸 New 语句（BC30035）\r\n        End Sub\r\n#End If\r\n");
     } 
